...
export const ClothePage = () => {
  ...
  /// OBTENER EL PRIMER COLOR SI NO HAY NINGUNO
  ...
  // ACTUALIZAR ALMACENAMIENTO (TALLES) CUANDO CAMBIA EL COLOR
  useEffect(() => {
    ...
    <>
      <div className="h-fit flex flex-col md:flex-row gap-16 mt-8">
        ...
        <div className="flex-1 space-y-5">
              ...
              {availableColors.map((color) => (
                <button
                  ...
                  onClick={() => {
                    ...
                    const firstStorage = colors[color]?.storage[0];
                    setSelectedStorage(firstStorage || null);
                  }}
                >
                  <span
          ...
          {/* OPCIONES DE TALLES */}
          <div className="flex flex-col gap-3">
            <p className="text-xs font-medium">Talles disponibles</p>
