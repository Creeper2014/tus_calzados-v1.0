...
import { ClotheTableProduct } from "./ClotheTableProduct";
                        ...
                        {products.map((product, index) => {
                            ...
                            return (
                                <tr key={index}>
                                    ...
                                    <ClotheTableProduct content={product.name} />
                                        ...
                                        {openMenuIndex === index && (
                                            <div 
                                                ...
                                                role="menu">
                                                    ...
                                                    <button
                                                        className='block w-full text-left px-4 py-2 text-xs font-medium text-gray-700 
                                                    hover:bg-gray-100'
