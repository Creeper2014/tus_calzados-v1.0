...
export const Navbar = () => {
    ...
    return ( 
        <header className=' bg-black text-white py-4 flex items-center justify-between px-5 border-b border-slate-200 lg:px-12'>
            <Logo />
                ...
                {navbarLinks.map(link => (
                       <NavLink
                            ...
                            className={({ isActive }) => 
                                ...
                                } transtion-all duration-300 font-medium hover: text-white hover:underline ` 
                            }
                        >
                            {link.title}
                       </NavLink>
