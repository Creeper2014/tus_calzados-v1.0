        ...
        <footer className="py-16 bg-gray-950 px-12 flex justify-between gap-10 text-slate-200 text-sm flex-wrap mt-10 md:flex-nowrap">
            ...
            <div className="flex flex-col gap-4 flex-1">
                ...
                <nav className="flex flex-col gap-2 text-xs font-medium">
                    ...
                    <Link to="/privacidad" className="text-slate-300 hover:text-white">
            ...
            <div className="flex flex-col gap-4 flex-1">
                ...
                <nav>
                    <Link to="/boton-arrepentimiento">Botón de arrepentimiento</Link>
                </nav>
                <p className="font-semibold uppercase tracking-tighter">
                    Soporte
                </p>
                <nav>
                    <Link to="#">tuzcalzados.support@gmail.com</Link>
                </nav>
            </div>
            ...
            <div className="flex flex-col gap-4 flex-1">
                ...
                <p className="text-xs leading-6">
                    No te pierdas nuestras prendas más recientes y ofertas exclusivas.
                </p>
                ...
                <div className="flex">
                    {socialLinks.map(Link => (
                        <a 
                            ...
                            target="_blank" 
                            rel="noreferrer"
                            className="text-slate-300 border border-gray-8000 w-full h-full py-3.5 flex items-center justify-center
